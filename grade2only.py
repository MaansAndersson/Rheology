...
Ycg = TensorFunctionSpace(mesh, "CG", pdeg, shape = (3,3))
...
ZeroV = Expression(("0","0","0"),degree = pdeg)
ZeroQ = Expression(("0"), degree = pdeg)
ZeroY = Expression((("0","0","0"),("0","0","0"),("0","0","0")), degree = pdeg)
